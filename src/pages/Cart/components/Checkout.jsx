...
const Checkout = ({setCheckout}) => {
  ...
  return (
   <section>
        <div className="fixed top-0 left-0 w-full h-full bg-black/50 bg-opacity-80"></div> 
        
        <div id="authentication-modal" tabIndex="-1" className="mt-5 overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 w-full md:inset-0 h-modal md:h-full justify-center pt-12 items-center flex" aria-modal="true" role="dialog" >
