...
const DashboardCard = ({order}) => {
  ...
  return (
    <div className='max-w-4xl m-autoo p-2 border dark:border-slate-700'>
        <div className='flex justify-between text-sm m-2 font-bold dark:text-slate-100'>
            <span>Order Id: 2</span>
            <span>Total : $48</span>
        </div>

        <div className='flex flex-wrap justify-between max-w-4xl m-aouto p-2 my-5'>
            <div className='flex'>
